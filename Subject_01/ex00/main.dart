...
void main() {
  ...
  //final sorted = new SplayTreeMap<int?, String?>.from(SpaceData, (a, b) => a.value.compareTo(b.value));
  final sortedByValueMap = Map.fromEntries(SpaceData.entries.toList()
    ..sort((e1, e2) => e1.value.compareTo(e2.value)));

  //print(sortedByValueMap);
  for (final String key in sortedByValueMap.keys) {
    print("$key : ${sortedByValueMap[key]}");
  }
}
