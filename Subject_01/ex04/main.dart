...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Widget> _dough_image = <Widget>[
    Image.network("https://bit.ly/3nTOYgE"), //dough01
    Image.network("https://bit.ly/3ECSDpT"), //dough02
  ];

  final List<String> _sauce = <String>["토마토 소스", "특제 소스"];
  final List<Widget> _sauce_image = <Widget>[
    Image.network("https://bit.ly/3mBUgOr"), //sauce01
    Image.network("https://bit.ly/3mDPdxc"), //sauce02
  ];

  final List<String> _cheese = <String>["모짜렐라 치즈", "고르곤졸라 치즈"];
  final List<Widget> _cheese_image = <Widget>[
    Image.network("https://bit.ly/3bwboii"), //cheese01
    Image.network("https://bit.ly/3w6PYBZ"), //cheese02
  ];

  final List<String> _mainItem = <String>["페퍼로니", "null", "감자", "베이컨"];
  final List<Widget> _main_image = <Widget>[
    Image.network("https://bit.ly/3nOEvTK"), //pep
    Image.network("https://bit.ly/3GFnG6x"), //null
    Image.network("https://bit.ly/3nTYdxD"), //pot
    Image.network("https://bit.ly/3GCV1Pr"), //bac
  ];
